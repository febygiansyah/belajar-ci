...
<html lang= "en">
	<head>
		...
		<link href= "<?php echo base_url('assets/css/admin.css'); ?>" type= "text/css" rel= "stylesheet" media= "screen,projection"/>
			...
			<nav class= "light-blue lighten-1 navbar-fixed" role= "navigation">
				<div class= "nav-wrapper container">
					<a id= "logo-container" href= "<?php echo base_url('#'); ?>" class= "brand-logo center">
						<img src= "<?php echo base_url('assets/images/logo.png'); ?>" alt= "admin logo">
					</a>
