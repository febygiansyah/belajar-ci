...
<html lang="en">
  ...
  <body>
    <nav class="light-blue lighten-1" role="navigation">
      <div class="nav-wrapper container"><a id="logo-container" href="<?php echo base_url(); ?>" class="brand-logo">Codeigniter</a></div>
    </nav>
      ...
      <div class="container login-box">
        <div class="card z-depth-5">
          <div class="card-content">
            ...
            <div class="row">
              <form class="col s12" id="login-form" method="post" action="<?php echo base_url('admin/auth/login'); ?>">
                <div class="row">
